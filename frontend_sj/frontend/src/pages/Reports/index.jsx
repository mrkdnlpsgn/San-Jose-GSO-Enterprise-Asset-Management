...
const REPORTS = [
  ...
  },
  {
    ...
    headers: [
      ...
      { label: 'Accumulated Depreciation',      display: (r) => fmtMoney(r.accumulatedDepreciation),                                                              raw: (r) => r.accumulatedDepreciation != null ? Number(r.accumulatedDepreciation).toFixed(2) : '' },
      { label: 'Accumulated Impairment Losses', display: () => '—',                                                                                               raw: () => '' },
      { label: 'Carrying Amount',               display: (r) => fmtMoney(r.carryingAmount),                                                                       raw: (r) => r.carryingAmount != null ? Number(r.carryingAmount).toFixed(2) : '' },
      ...
      { label: 'Others (Specify)',              display: (r) => r.recommendedMethod === 'OTHERS'      ? (r.asset?.quantity ?? 1) : '—',                           raw: (r) => r.recommendedMethod === 'OTHERS'      ? (r.asset?.quantity ?? 1) : '' },
